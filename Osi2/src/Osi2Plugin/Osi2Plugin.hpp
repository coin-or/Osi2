...
typedef int32_t (*PF_RegisterFunc)(const uint8_t * nodeType, const PF_RegisterParams * params);
typedef int32_t (*PF_InvokeServiceFunc)(const uint8_t * serviceName, void * serviceParams);
